...
const PostRecruitMember = ({ onPostSubmit, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('recruitMemberRequestDTO', new Blob([JSON.stringify(dto)], { type: 'application/json' }));
    if (newPost.image) {
  ...
  return (
    <div className="container mt-5">
      <h1 className="mb-4">부원 모집 게시글 등록</h1>
...
export default PostRecruitMember;
